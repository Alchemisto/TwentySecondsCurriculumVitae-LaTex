...
% LaTeX Template
% Version 2.0 (17-OCT-16)
% Version 1.0 (14/7/16)
% 
% The offical home for this 2nd Version Template is here:
% https://github.com/talbot-j/TwentySecondsCurriculumVitae-LaTex 
% Author: Joshua R. Talbot (talbot.j@gmail.com)
% 
...
% Auhor: Carmine Spagnuolo (cspagnuolo@unisa.it)
%
% License:
% The MIT License (see included LICENSE file)
%
%
% Special thanks to Mr. Spagnuolo who certainly did the majority of the leg 
% work to make this awesome piece of work come to life.
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Note: the command must stay!  Otherwise an error will occur.
...
\cvBitBucket{www.bitbucket.com}
\cvLinkedin{www.linkedin.com}
